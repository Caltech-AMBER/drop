(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fullCarousel"] = factory();
	else
		root["fullCarousel"] = factory();
...
var fullCarousel = function (_EventEmitter) {
  _inherits(fullCarousel, _EventEmitter);

  function fullCarousel(selector) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, fullCarousel);

    var _this = _possibleConstructorReturn(this, (fullCarousel.__proto__ || Object.getPrototypeOf(fullCarousel)).call(this));
    ...
    value: function attach() {
      ...
      [].forEach.call(elements, function (element) {
        if (typeof element[_this7.constructor.name] === 'undefined') {
          var instance = new fullCarousel(element, options);
...
/* harmony default export */ __webpack_exports__["default"] = (fullCarousel);
