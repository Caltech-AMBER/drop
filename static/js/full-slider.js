(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fullSlider"] = factory();
	else
		root["fullSlider"] = factory();
...
var fullSlider = function (_EventEmitter) {
  _inherits(fullSlider, _EventEmitter);

  function fullSlider(selector) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, fullSlider);

    var _this = _possibleConstructorReturn(this, (fullSlider.__proto__ || Object.getPrototypeOf(fullSlider)).call(this));
  ...
  _createClass(fullSlider, [{
     ...
     */
    value: function init() {
      this._id = 'fullSlider' + new Date().getTime() + Math.floor(Math.random() * Math.floor(9999));
      ...
      this.emit('fullslider:ready', this.element.value);
    }
  }, {
    ...
    value: function attach() {
      ...
      elements.forEach(function (element) {
        if (typeof element[_this3.constructor.name] === 'undefined') {
          var instance = new fullSlider(element, options);
...
/* harmony default export */ __webpack_exports__["default"] = (fullSlider);
